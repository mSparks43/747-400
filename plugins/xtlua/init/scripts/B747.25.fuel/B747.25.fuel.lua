...
function B747_fuelswitch_DRhandler()
    B747DR_dsp_synoptic_display = 1
end
B747_fuel_control_toggle_sw_pos_target = deferred_dataref("laminar/B747/fuel/switch_target", "array[4]", B747_fuelswitch_DRhandler)--{}
